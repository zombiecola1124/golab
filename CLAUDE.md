...
모든 사업 기획·투자·구매 건에 대해 재무팀이 비용과 수익 측면에서 냉정하게 검토한다. 다른 팀이 아이디어를 내면, 트럼프 장소장이 반드시 숫자로 태클을 건다.
