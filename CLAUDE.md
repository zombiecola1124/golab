...
| **R2 상호비판** | 트럼프 독설 비판 + 이박사 팩트 체크. 논리 허점 탐색 | **쟁점 요약 보고서** → 대표님 승인 |
...
2. **3회 에러 → 병목 보고** — 동일 에러가 3회 반복되면 즉시 작업 중지, **병목 보고서** 제출 (원인 분석 + 대안 제시)
...
- **즉시 중지 조건**: 핑퐁 3회 / 결론 번복 2회 / 데이터 전무 → 즉시 작업 중지
- **재개 절차**: 중지 후 **[재개를 위한 필요 조건]** 명시 보고 (예: 추가 데이터 확보, 대표님 방향 수정 등). 해당 조건 충족 시에만 재기동
